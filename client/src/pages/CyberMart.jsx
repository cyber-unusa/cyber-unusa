...
export default function CyberMart() {
  return (
    <>
      <Helmet>
        <title>Cyber Mart — Produk & Merchandise Resmi Cyber UNUSA</title>
        <meta
          name="description"
          content="Jelajahi produk dan merchandise resmi UKM Cyber UNUSA. Dari kaos, stiker, hingga produk digital karya mahasiswa IT UNUSA."
        />
      </Helmet>
          ...
          <div className="container mx-auto px-6 lg:px-16 flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0 lg:pr-12">
              ...
              <p className="font-poppins text-gray-600 text-lg mb-8 leading-relaxed">
                Jelajahi koleksi produk kami, dari merchandise keren seperti
                baju dan stiker hingga produk digital yang bermanfaat. Dibuat
                oleh anggota, untuk Anda.
              </p>
            </div>
            {/* Gambar */}
