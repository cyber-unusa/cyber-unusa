...
const ManageKegiatan = () => {
  ...
  const handleEditClick = (kegiatan) => {
    ...
    const formatDate = kegiatan.endDate
      ? new Date(kegiatan.endDate).toISOString().split("T")[0]
      : "";
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800">Manajemen Kegiatan</h2>
      ...
      >
        <div className="flex items-center gap-2 mb-6 text-lg font-semibold text-gray-700 border-b pb-2">
          {isEditing ? (
            <>
              <Edit className="w-5 h-5 text-yellow-600" /> Edit Kegiatan
            </>
          ) : (
            <>
              <Plus className="w-5 h-5 text-blue-600" /> Tambah Kegiatan Baru
            </>
          )}
        </div>
        ...
        >
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 flex justify-end gap-2 mt-2">
              ...
              >
                {isEditing ? "Simpan Perubahan" : "Publikasi Kegiatan"}
              </button>
            </div>
          </div>
        </form>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 bg-gray-100 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-200">
          ...
          <div className="col-span-4">Info Kegiatan</div>
              ...
              >
                ...
                <div className="md:col-span-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-blue-500 text-xs hover:underline flex items-center gap-1 mt-1"
                  >
                    <LinkIcon className="w-3 h-3" /> {doc.link}
                  </a>
                </div>
                <div className="md:col-span-3 text-sm text-gray-600">
                  <span className="bg-red-50 text-red-600 px-2 py-1 rounded text-xs font-medium border border-red-100">
                    Akhir: {formatDate(doc.endDate)}
                  </span>
                </div>
